...
namespace iatray
{
    public partial class ImportQueueForm : Form
    {
        ...
        public ImportQueueForm()
        {
            ...
            imageListSmall.Images.Add(iatray.Properties.Resources.pending);
            imageListSmall.Images.Add(iatray.Properties.Resources.inprogress);
            imageListSmall.Images.Add(iatray.Properties.Resources.completed);
