...
namespace iachkin
{
    public partial class CheckinProgressForm : Form
    {
        ...
        public CheckinProgressForm(List<string> files, string exePath, string workingPath)
        {
            InitializeComponent();
            m_files = files;
            m_exePath = exePath;
            m_workingPath = workingPath;
            this.labelProcess.Text = "Check-in";
            this.Name = "Check-in Calculating...";
        ...
        public async Task<int> ProgressData()
        {
            ...
            foreach (string file in m_files)
            {
                ...
                launchCommandLine.Arguments = "checkin --scope=\"" + fileAddress + "\"";
